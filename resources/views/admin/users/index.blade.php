                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center items-center space-x-2">
                                    ...
                                    <form id="delete-form-{{ $user->id }}" action="{{ route('admin.users.destroy', $user) }}" method="POST" class="inline">
                                        @csrf @method('DELETE')
                                        <button type="button" onclick="confirmDelete('{{ $user->id }}', 'Pengguna {{ $user->name }} akan dihapus.')" class="p-2 rounded-lg bg-gray-50 text-gray-400 hover:text-red-500 hover:bg-red-50 transition">
