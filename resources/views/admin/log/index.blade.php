                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($logs as $log)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 ucfirst">{{ $log->user->role }}</td>
                                        <td class="px-6 py-4 text-sm text-gray-500">{{ $log->aktivitas }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-6 py-4 text-center text-gray-500">Tidak ada log aktivitas.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
