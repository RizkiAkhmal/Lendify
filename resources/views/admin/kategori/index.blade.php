                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center items-center space-x-2">
                                    ...
                                    <form action="{{ route('admin.kategori.destroy', $item) }}" method="POST" class="inline" onsubmit="return confirm('Hapus kategori ini? Seluruh alat di kategori ini mungkin akan terdampak.');">
                                        @csrf @method('DELETE')
