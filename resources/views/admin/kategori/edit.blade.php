                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.kategori.update', $kategori) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="3" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
